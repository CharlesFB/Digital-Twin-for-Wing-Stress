...
{
    public class LineGraphTest2 : MonoBehaviour
    {
        ...
        [SerializeField] private LineGraph2 lineGraph;
        ...
        public static float GenerateNormalRandom(float mean = 0f, float stdDev = 1f, float min = -55f, float max = 55f)
        {
        ...
        public void EnqueueQL(float x)
        {
            ...
            ql.Enqueue(x);
            mockPrediction.Enqueue(x + GenerateNormalRandom(0, 8) + mock_offset);
        }
